...
public class Add implements ComputationalNode {
	...
	public Add(ComputationalNode k1, ComputationalNode k2)
	{
		this.k1 = k1;
		this.k2 = k2;
	}
	...
	public ComputationalNode derivative(String unknown) {
		// TODO Auto-generated method stub
		return new Add(k1.derivative(unknown), k2.derivative(unknown));
	}
	...
	public ComputationalNode cleanUp() {
		...
		if (k1 instanceof Constant && k2 instanceof Constant)
			return new Constant(this.evaluate("i bims 1 Addition"));
		if (k1.isZero())
			return k2;
		else if (k2.isZero())
			return k1;
		return new Add(k1, k2);
	}
